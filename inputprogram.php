...
<head>
    ...
    <title>PMElectric | Program</title>
        ...
        <div class="card--container">
            ...
            <form method="POST" action="">
                <div class="container">
                    ...
                    <input type="text" placeholder="Masukkan PIC" name="program_pic"><br><br>

                    <label for="">Start</label><br>
                    <input type="date" placeholder="Masukan Waktu Start" name="program_start"><br><br>

                    <label for="">END</label><br>
                    <input type="date" placeholder="Masukan Waktu End" name="program_end"><br><br>
