...
<head>
    ...
    <title>PMElectric | Nesting</title>
        ...
        <div class="card--container">
            ...
            <form method="POST" action="">
                <div class="container">
                    ...
                    <input type="hidden" name="page" value="nesting">
                    ...
                    <input type="text" placeholder="Masukkan PIC" name="nesting_pic"><br><br>

                    <label for="">Start</label><br>
                    <input type="date" placeholder="Masukan Waktu Start" name="nesting_start"><br><br>

                    <label for="">END</label><br>
                    <input type="date" placeholder="Masukan Waktu End" name="nesting_end"><br><br>
